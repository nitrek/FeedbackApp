...
public class MainVerticle extends AbstractVerticle {
    ...
    Future<Void> deployOtherVerticles(Void unused) {
        ...
        //Future<String> dbVerticle = Future.future(promise -> vertx.deployVerticle(new PostgresVerticle(), opts, promise));

        Future<String> webVerticle = Future.future(promise -> vertx.deployVerticle(new WebVerticle(), opts, promise));

        Future<String> userVerticle = Future.future(promise -> vertx.deployVerticle(new UserVerticle(), opts, promise));

        return CompositeFuture.all(userVerticle, webVerticle).mapEmpty();
    }
}
